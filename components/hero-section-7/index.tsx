...
export default function HeroSection7() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      gradient.addColorStop(0, "#ffdd33")
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 120) {
            ...
            ctx.strokeStyle = `rgba(120, 53, 15, ${alpha * 0.35})`
            ctx.beginPath()
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden font-sans">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-br from-yellow-300/40 via-yellow-400/20 to-amber-200/40" />
